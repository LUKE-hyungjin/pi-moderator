      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <section className="bg-[rgba(255,255,255,0.05)] rounded-2xl p-8">
          ...
          <p className="text-gray-300 mb-6 text-center">
            Pi Exchange는 파이코인 커뮤니티의 성장과 발전을 위해 시작되었습니다.
        ...
        <section className="grid md:grid-cols-2 gap-8">
          <div className="bg-[rgba(255,255,255,0.05)] rounded-xl p-6">
            ...
            <Link to="/pi" className="text-blue-400 hover:text-blue-300">
              자세히 알아보기 →
            </Link>
          </div>
          ...
          <div className="bg-[rgba(255,255,255,0.05)] rounded-xl p-6">
            ...
            <Link to="/map" className="text-red-400 hover:text-red-300">
              거래소 찾기 →
            </Link>
          </div>
          ...
          <div className="bg-[rgba(255,255,255,0.05)] rounded-xl p-6">
            ...
            <Link to="/map" className="text-green-400 hover:text-green-300">
              세무사 찾기 →
            </Link>
          </div>
        ...
        <section className="text-center bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl p-8">
          ...
          <p className="text-gray-300 mb-6">
            Pi Exchange와 함께라면 파이코인의 가치는 더욱 빛날 수 있습니다.
          </p>
          <Link
            to="/user"
