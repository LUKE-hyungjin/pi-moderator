export const en = {
    ...
    // Map Page
    'user.map.title': 'Service Map',
    'user.map.description': 'Find Pi Network services near you',
    'user.map.search.placeholder': 'Search by address...',
    'user.map.add_place': 'Add Place',
    'user.map.filter.title': 'Filter by Service Type',

    // Map Place Form
    'user.map.place.form.title': 'Register Place',
    'user.map.place.form.name': 'Place Name',
    'user.map.place.form.name.placeholder': 'Enter place name',
    'user.map.place.form.type': 'Service Type',
    'user.map.place.form.type.placeholder': 'Select service type',
    'user.map.place.form.address': 'Address',
    'user.map.place.form.address.placeholder': 'Enter address',
    'user.map.place.form.phone': 'Phone Number',
    'user.map.place.form.phone.placeholder': 'Enter phone number',
    'user.map.place.form.description': 'Description',
    'user.map.place.form.description.placeholder': 'Enter place description',
    'user.map.place.form.image': 'Representative Image',
    'user.map.place.form.submit': 'Register',
    'user.map.place.form.cancel': 'Cancel',

    // Map Place Types
    'user.map.place.type.education': 'Education',
    'user.map.place.type.relay': 'Exchange',
    'user.map.place.type.tax': 'Tax',

    'user.map.place.form.image.description': 'Please upload an image in JPG, PNG, or GIF format.',
    'user.map.place.form.type.warning': 'Changing the category will clear the existing content.',
    'user.map.place.form.location': 'Select Location',
    'user.map.place.form.location.description': 'Click on the map to select a location',
    'user.map.place.form.error.auth': 'User authentication required.',
    'user.map.place.form.error.upload': 'An error occurred while uploading the image.',
    'user.map.place.form.error.save': 'An error occurred while adding the place.',

    // Templates
    'template.education.title': 'Education Information',
    'template.education.type': '📚 Education Type',
    'template.education.type.placeholder': '[Select: Offline/Online/Hybrid]',
    'template.education.capacity': '👥 Capacity',
    'template.education.capacity.placeholder': '[Enter number]',
    'template.education.curriculum': '📝 Curriculum Introduction',
    'template.education.instructor': '👨‍🏫 Instructor Information',
    'template.education.fee': '💰 Education Fee',
    'template.education.schedule': '📅 Schedule',
    'template.education.table.order': 'Order',
    'template.education.table.time': 'Time',
    'template.education.table.content': 'Content',
    'template.education.table.manager': 'Manager',
    'template.education.other': 'ℹ️ Other Information',

    'template.relay.title': 'Relay Service Information',
    'template.relay.method': '🔄 Relay Method',
    'template.relay.method.placeholder': '[Select: Direct/Agency]',
    'template.relay.hours': '⏰ Operating Hours',
    'template.relay.hours.placeholder': '[e.g., 09:00-18:00]',
    'template.relay.area': '📍 Service Area',
    'template.relay.fee': '💰 Relay Fee',
    'template.relay.notes': '📋 Notes',

    'template.tax.title': 'Tax Service Information',
    'template.tax.service': '💼 Tax Service',
    'template.tax.service.placeholder': '[Select: Individual/Corporate/Both]',
    'template.tax.specialty': '📊 Specialization',
    'template.tax.fee': '💵 Service Fee',
    'template.tax.hours': '🕒 Consultation Hours',
    'template.tax.credentials': '📜 Credentials & Experience',
}; 